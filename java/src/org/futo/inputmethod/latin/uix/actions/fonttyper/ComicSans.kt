...
object ComicSansRenderer : WordImageRenderer() {
    override val name: Int
        get() = R.string.action_fonttyper_preset_title_comic_sans

    override fun renderLine(
        context: Context,
        text: String
    ): LineRenderResult? {
        val textColor = 0xFF4169E1.toInt()
...
private fun PreviewRenderer() {
    ...
    val renderer = ComicSansRenderer
    val image = remember {
