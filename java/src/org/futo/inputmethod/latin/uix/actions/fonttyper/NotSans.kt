...
object NotSansRenderer : WordImageRenderer() {
    override val name: Int
        get() = R.string.action_fonttyper_preset_title_not_sans
    ...
    override fun renderLine(
        ...
        val backgroundColor = 0xFFF5F5F5.toInt()
